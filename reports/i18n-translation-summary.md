...
**Generated At:** 2026-09-12T10:19:03.328Z
...
| :--- | :--- | :--- | :--- |
| **Total Entries Processed** | **9429** | 100.0% | Complete catalog coverage |
| **Generated English Proposals** | **9429** | 100.0% | English target translation proposals |
| **Generated Urdu Proposals** | **9429** | 100.0% | Urdu target translation proposals |
| **Review-Required Proposals** | **9424** | 99.9% | Flagged for human translator sign-off |
| **High-Risk Entries** | **9424** | 99.9% | Formulas, conflicts, or complex templates |
...
| **Semantic Conflicts Isolated** | **834** | 8.8% | Distinct contextual keys maintained |
...
| **LOW** | **6524** | 69.2% | Ambiguous phrases, high risk, or conflicts (Review Mandatory) |
...
| **Tier 4: High Risk** | **9424** | Semantic conflicts, complex templates, mixed calculations |

## 4. Category Breakdown

| Category | Total Entries | Generated | Review Required | High Conf | Med Conf | Low Conf |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| `other` | 2267 | 2267 | 2265 | 79 | 478 | 1710 |
...
| `navigation` | 293 | 293 | 293 | 2 | 77 | 214 |
...
| `BUSINESS_DATA_RISK` | **1431** | Triggered by rule engine classification |
| `LOW_CONFIDENCE` | **9424** | Triggered by rule engine classification |
