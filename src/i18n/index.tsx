...
import {AppTranslationKey} from './catalog';
...
type I18nContextValue={locale:Locale;dir:'rtl'|'ltr';resource:LocaleResource;setLocale:(locale:Locale)=>void;t:(path:AppTranslationKey)=>string};
